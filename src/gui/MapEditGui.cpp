...
std::vector<ImTextureID> sg::gui::MapEditGui::CreateButtonTextures()
{
    ...
    const auto& raiseTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/raise.png") };
    const auto& lowerTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/lower.png") };
    const auto& rTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/r.png", true) };
    const auto& cTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/c.png") };
    const auto& iTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/i.png") };
    const auto& tTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/traffic.png") };
    const auto& plantTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/trees.png") };
    const auto& infoTexture{ ogl::resource::ResourceManager::LoadTexture(Game::RESOURCES_PATH + "texture/info.png") };
